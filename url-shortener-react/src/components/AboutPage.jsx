    ...
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        <p className="text-gray-700 text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          BlinkURL is a fast and secure URL shortening platform that helps you create
          compact, shareable links in seconds. Manage your links, track engagement,
          and organize your URLs effortlessly through a simple and intuitive interface.
        </p>
